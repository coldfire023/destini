...
//TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  ...
  int? nextStory(int choiceNumber) {
    if (_storyNo == 0 && choiceNumber == 1) {
      _storyNo = 2;
    } else if (_storyNo == 0 && choiceNumber == 2) {
      _storyNo = 1;
    } else if (_storyNo == 1 && choiceNumber == 2) {
      _storyNo = 3;
    } else if (_storyNo == 1 && choiceNumber == 1) {
      _storyNo = 2;
    } else if (_storyNo == 2 && choiceNumber == 2) {
      _storyNo = 4;
    } else if (_storyNo == 2 && choiceNumber == 1) {
      _storyNo = 5;
